<script lang="ts">
  ...
  const STEAM_URL = 'https://store.steampowered.com/app/3799160/VPetlings/';
  const TWITTER_URL = 'https://x.com/sargantanagames';
  const INSTAGRAM_URL = 'https://www.instagram.com/sargantanagames/';
...
<svelte:head>
  ...
  <meta property="og:title" content="VPetlings" />
  <meta
  ...
  <meta name="twitter:title" content="VPetlings - A Cozy Virtual Pet on Your Desktop" />
  <meta
...
<div class="min-h-screen h-full flex flex-col bg-bg text-text">
  <Navbar steamUrl={STEAM_URL} />

  <main class="p-4 flex-1 w-full max-w-6xl mx-auto text-xl">
    {@render children()}
  </main>

  <Footer twitterUrl={TWITTER_URL} instagramUrl={INSTAGRAM_URL} steamUrl={STEAM_URL} />
</div>
